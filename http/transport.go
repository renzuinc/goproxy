...
func (t *Transport) getConn(req *Request, cm connectMethod) (*persistConn, error) {
	...
	case <-cancelc:
		handlePendingDial()
		return nil, errors.New("github.com/renzuinc/goproxy/http: request canceled while waiting for connection")
	}
}
...
var errTimeout error = &httpError{err: "github.com/renzuinc/goproxy/http: timeout awaiting response headers", timeout: true}
var errClosed error = &httpError{err: "github.com/renzuinc/goproxy/http: transport closed before response was received"}
...
func (tlsHandshakeTimeoutError) Error() string {
	return "github.com/renzuinc/goproxy/http: TLS handshake timeout"
}
